...
/**
 * Servlet implementation class SegnaUscitaServlet
 */
@WebServlet("/SegnaUscita")
public class SegnaUscitaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SegnaUscitaServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			ControllerDB.setUscitaLido(data, turno, idUtente);
		} catch (Exception e) {
